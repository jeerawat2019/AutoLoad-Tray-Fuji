...
{
    public class PLC_Builder
    {
        private static PLC_Commu PLC_Setting
        {
            get;
            set;
        } = new PLC_Commu();
        ...
        /// 
        /// </summary>
        public static int AxActOpen(PLC_Commu sPLC_Setting)
        {
            try {
                PLC_Setting = sPLC_Setting;
                if (sPLC_Setting == null) {
                    throw new PLC_Exception("");
                }
                if (!sPLC_Setting.IsNetworkConnect) {
                    throw new PLC_Exception("");
                }
                ...
                if (GetIntValue(PLC_Setting.iStstionNumber.ToString(), out iLogicalStationNumber) != true) {
                    //If failed, this process is end.			
                    return -1;
                }
                PLC_Setting.mActUtlTypeClass.ActLogicalStationNumber = iLogicalStationNumber;
                //The Open method is executed.
                iReturnCode = PLC_Setting.mActUtlTypeClass.Open();
        ...
        /// <returns></returns>
        public static int WriteDeviceRandom2(string sDeviceName, string sNumberOfData, TextBox sValue)
        {
            ...
            arrDeviceValue = new short[iNumberOfData];
            if (!GetShortArray(sValue, out arrDeviceValue)) {
                //If failed, this process is end.	
                return -1;
            }
            ...
            try {
                ...
                iReturnCode = PLC_Setting.mActUtlTypeClass.WriteDeviceRandom2(szDeviceName,
                                                              iNumberOfData,
        ...
        /// <param name="sValue"></param>
        /// <returns></returns>
        public static int ReadDeviceRandom2(TextBox sDeviceName, string sNumberOfData ,out string[] OutValue )
        {
            int iReturnCode;				//Return code
            String szDeviceName = "";		//List data for 'DeviceName'
            int iNumberOfData = 0;			//Data for 'DeviceSize'
            ...
            try {
                ...
                iReturnCode = PLC_Setting.mActUtlTypeClass.ReadDeviceRandom2(szDeviceName,
                                                                iNumberOfData,
        ...
        public static int WriteMuiltiWordData(string WordStart ="D1000" ,string strWriteWord ="",int ELEMENT_SIZE_WORD = 40)
        {
            try {
                ...
                iReturnCode = PLC_Setting.mActUtlTypeClass.WriteDeviceBlock2(WordStart, ELEMENT_SIZE_WORD, ref sharrBufferForDeviceValue[0]);// "R32000"
        ...
        /// <returns></returns>
        public static int ReadMuiltiWordData(int ElementSize, string address, out string strDataWord )
        {
            //450
            try {
                ...
                iReturnCode = PLC_Setting.mActUtlTypeClass.ReadDeviceBlock2(address, ElementSize, out sharrBufferForDeviceValue[0]);
                //When ActUtlType returns error code, display error message.
                if (iReturnCode != 0) {
                    DisplayErrorMessage(iReturnCode);
                    return 0;
        ...
        /// <returns></returns>
        private static bool GetShortArray(TextBox lptxt_SourceOfShortArray, out short[] lplpshShortArrayValue)
        {
        ...
        /// 
        /// </summary>
        /// <param name="lptxt_SourceOfIntValue"></param>
        /// <param name="iGottenIntValue"></param>
        /// <returns></returns>
        #region "Processing of getting 32bit integer from TextBox"

        private static bool GetIntValue(string lptxt_SourceOfIntValue, out int iGottenIntValue)
        {
            iGottenIntValue = 0;
        ...
        private static void DisplayErrorMessage(int iReturnCode)
        {
            ...
            iSupportReturnCode = PLC_Setting.mActSupportMsgClass.GetErrorMessage(iReturnCode, out sActErrorMessage);
